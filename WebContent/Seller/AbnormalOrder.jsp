	...
	<table border="1" id="DataGrid1" align="center"
		...
		<c:forEach items="${orders}" var="p">
			<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
				...
				<td  align="center"><input  style="width: 300px;HEIGHT: 22px;" type="text" name="order_abnormal_info" value="${p.order_abnormal_info }" readonly="readonly"></td>		
			</tr>
		</c:forEach>            					
	</table>
