...
<script type="text/javascript">
		function addOil() {
			window.location.href = "${pageContext.request.contextPath}/Admin/AddOil.jsp";
		}
	    function findAllOil(){
	    	window.location.href = "${pageContext.request.contextPath}/FindAllOilServlet";
	    }
		function p_del() {   
			var msg = "您确定要下架该商品吗？";   
			if (confirm(msg)==true){   
...
<div class="nav">
		...
		action="${pageContext.request.contextPath}/FindByManyConditionsServlet"
	...
	<table>
		...
		<tr>
			...
			<td width="300px">
				容量（L）<input style="width: 100px" type="text" name="oil_capacity"  id="oil_capacity" placeholder="L" >
			</td>
			<td width="300px">
	...
	<button id="add" type="button" onClick="addOil()">增加食用油</button>
	...
	<table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1"
		...
		<form id="Form2" name="Form2" action="${pageContext.request.contextPath}/Admin/UpdateOil.jsp" method="post">
			<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
				...
				<td align="center" style="HEIGHT: 22px" >
				<a href="${pageContext.request.contextPath}/RemoveOilServlet?oil_id=${p.oil_id}" onclick="javascript:return p_del()">
