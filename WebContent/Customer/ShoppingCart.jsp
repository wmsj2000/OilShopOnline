	...
	<table border="1" id="DataGrid1" align=center 
		...
		<form id="Form2" name="Form2" action="${pageContext.request.contextPath}/BuyOilServlet?oil_id=${p.oil_id}" method="post">
			<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
				<td  align="center" ><input  align="middle" style="width: 50px;HEIGHT: 22px;" type="text" name="id" value="${status.index+1}" readonly="readonly"></td>
				...
				<td  align="center"><input  style="width: 60px;HEIGHT: 22px;" type="text" name="buy_number"value="1"></td>
