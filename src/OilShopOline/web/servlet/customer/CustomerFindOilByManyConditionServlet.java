...
/**
 * Servlet implementation class CustomerFindOilByManyConditionServlet
 */
@WebServlet("/CustomerFindOilByManyConditionServlet")
public class CustomerFindOilByManyConditionServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CustomerFindOilByManyConditionServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String oil_id="";
		String oil_number1="1";
		String oil_number2="99999999";
		String oil_state="true";
