...
/**
 * Servlet implementation class BrowseLogServlet
 */
@WebServlet("/BrowseLogServlet")
public class BrowseLogServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Browse> browse = null;
		try {
			browse = dao.showBrowseByBrand(brand);
			...
			request.getRequestDispatcher("/Seller/BrowseLog.jsp").forward(request, response);
		} catch (Exception e) {
