...
/**
 * Servlet implementation class SellerRemoveOilServlet
 */
@WebServlet("/SellerRemoveOilServlet")
public class SellerRemoveOilServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SellerRemoveOilServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String info = "œ¬º‹…Ã∆∑£¨°æ±‡∫≈°ø£∫°æ"+oil_id+"°ø";
			MDC.put("name",name);
			MDC.put("role",role);
			...
			logger.info("");
			response.sendRedirect(request.getContextPath() + "/OilManageServlet");
